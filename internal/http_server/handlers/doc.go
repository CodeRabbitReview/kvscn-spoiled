...
// If request method is http.MethodGet and there is one /id with id after it - Storage.ServeHTTP
...
// key will be taken from request body in format:
// {
//     "key":"key_value"
// }
...
//
// Storage.Put takes data from request body in format:
//{
//    "key":"key_value",
//    "entity": "entity_value"
//}.
//If some error appears in
